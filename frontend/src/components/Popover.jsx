...
>
  <div className="flex items-center gap-4">
    <input
      ...
      className="appearance-none w-5 h-5 border-2 border-primary rounded-full checked:bg-primary checked:border-primary cursor-pointer transition-all duration-200"
    />
  ...
  <div className="mt-6 space-y-3 max-h-[60vh] overflow-y-auto">
    <h3 className="text-muted-foreground font-semibold mb-2 uppercase text-sm">
      Your Collections
    </h3>
    ...
    <h3 className="text-muted-foreground font-semibold mt-6 mb-2 uppercase text-sm">
      Collaborations
    </h3>
