              ...
              <Card className="w-full max-w-md modern-card border border-gray-200 shadow-2xl">
                <CardHeader className="text-center relative">
                  ...
                  >
                    ...
                    <span className="text-xl font-bold modern-text modern-title">Upload Content</span>
                  </motion.div>
                  ...
                  >
                    <CardTitle className="text-lg modern-title text-gray-900">Share Your Creativity</CardTitle>
                ...
                <CardContent>
                  <form onSubmit={handleSubmit} className="flex flex-col gap-6">
                    ...
                    >
                      <Label htmlFor="title" className="modern-subtitle text-gray-700">Title</Label>
                      <Input
                        id="title"
                        type="text"
                    ...
                    <motion.div
                      ...
                      className="grid gap-2"
                    >
                      <Label htmlFor="description" className="modern-subtitle text-gray-700">Description</Label>
                      <textarea
                        id="description"
                    ...
                    <motion.div
                      ...
                      className="grid gap-2"
                    >
                      <Label htmlFor="category" className="modern-subtitle text-gray-700">Category</Label>
                    ...
                    <motion.div
                      ...
                      className="grid gap-2"
                    >
                      <Label htmlFor="attachment" className="modern-subtitle text-gray-700">Upload File</Label>
